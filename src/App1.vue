...
const openSetting = async () => {
  ...
  //await plugin.saveData(File, data)
  alert('Need open plugin setting.')
  const STORAGE_NAME = "test"
  const textareaElement = document.createElement("textareaValue");
...
onMounted(() => {
  window._sy_plugin_lsky_upload = {}
  window._sy_plugin_lsky_upload.openSetting = openSetting
})
</script>
